...
ViewEditor.prototype.init = function(sidebar, rpc) {
	...
	this.$titleEditImg = this.$htmlPart.find('.titleEditImg');
...
ViewEditor.prototype.fillEditor = function() {
	...
	this.$titleEditImg.attr("src","img/edit.png");
	this.$titleEditImg.bind("click", function(eventObject) {
		eventObject.preventDefault();
		me.activateTitleEdit();
	});
...
ViewEditor.prototype.activateTitleEdit = function() {
	...
	this.$titleEditImg.attr("src","img/OK.png");
	this.$titleEditImg.bind("click", function(eventObject) {
		eventObject.preventDefault();
